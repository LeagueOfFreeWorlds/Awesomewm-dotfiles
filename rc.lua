...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "d", function () awful.util.spawn( "rofi-theme-selector" ) end,
    ...
    awful.key({ modkey1, altkey}, "q", function() xrandr.xrandr() end,
            {description = "Monitor switcher", group = "alt+ctrl"}),
...
--Media keys supported by mpd.
    ...
    -- I uncommented this part because it meseses with Ctrl+Shift highlighting. 
